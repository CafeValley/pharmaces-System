<?php
$formtitle = "Users List";
$formaction = "report_users.php";
$systemname = "MMC";
...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box">
      <div class="box-body">
        <?php
        $result = $conn->query("SELECT id, name, address, phone, username, usertype, whenwasit, whodidit FROM users ORDER BY name");
            ...
            <?php $i=0; while ($row = $result->fetch_assoc()) { $i++; ?>
              <tbody>
                <tr>
                  ...
                  <td><?php echo htmlspecialchars($row['usertype'], ENT_QUOTES, 'UTF-8'); ?></td>
