<?php
$formtitle = "Medicine";
$formaction = "adddraglimit.php";
$systemname = "MMC";
include('connection.php');
include('funitem.php');
include("front.php");
$maindrags = 'active';
$dragslimmit = 'class="active"';
include("menu.php");
?>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      if (isset($_POST['save'])) {
        //print_r($_POST);
        $var1 = $_POST['drugid'];
        $var2 = $_POST['limitamount'];


        $sql = " INSERT INTO `item_limmit`(`item_id`, `amount`, `whenwasit`, `whodidthis`) VALUES ('$var1','$var2',now(),'admin')";
      ...
      <div class="box-body">
        <form action="<?php echo $formaction; ?>" method="POST" role="form">
          ...
          <div class="form-group">
            ...
            <input type="text" name="limitamount" class="form-control" placeholder="Enter ...">
          </div>
